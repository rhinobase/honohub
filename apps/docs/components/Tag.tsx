...
const colorStyles = {
  ...
  secondary: {
    small: "text-secondary-400 dark:text-secondary-500",
    medium:
      "ring-secondary-200 bg-secondary-50 text-secondary-500 dark:ring-secondary-500/20 dark:bg-secondary-400/10 dark:text-secondary-400",
  },
};
