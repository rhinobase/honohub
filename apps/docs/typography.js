    ...
    return {
      DEFAULT: {
        css: {
          ...
          "--tw-prose-links-underline": theme("colors.primary.600"),
          ...
          "--tw-prose-hr": theme("colors.secondary.900 / 0.05"),
          ...
          "--tw-prose-code-ring": theme("colors.secondary.300"),
          ...
          "--tw-prose-invert-code-bg": theme("colors.secondary.700 / 0.15"),
