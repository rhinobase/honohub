...
<div className="not-prose">
  <Link
    href="#event-types"
   className="text-primary-500 w-max hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-300 transition-all mt-4 flex items-center gap-1.5 font-semibold"
>
    <p>See all event types</p>
