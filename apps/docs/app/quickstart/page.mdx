...
HonoHub is a middleware that seamlessly integrates into your existing setup without imposing any restrictions on your setup or other middlewares. Unlike traditional frameworks, HonoHub provides flexibility, allowing you to customize and extend your application as needed.
...
### Add HonoHub in your Hono Project
...
- [Customize your HonoHub APIs](/setup/configuration)
- [Setup and explore the Admin Panel](/development/admin-panel)
- [Explore Plugins](/plugins/introduction)
