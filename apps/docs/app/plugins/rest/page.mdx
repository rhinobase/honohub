...
### Optional attributes
    ...
    <Properties>
      ...
      <Property name="limit" type="number">
        The number of records to return per page. This shouldn't be more then the `maxLimit` defined in your collection schema.
      </Property>
...
<Row>
  <Col>
    ## Delete Records {{ tag: 'DELETE', label: '/collections/todos' }}
